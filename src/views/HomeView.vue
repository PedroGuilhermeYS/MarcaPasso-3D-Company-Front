  ...
  const irPersonalizar = () => router.push({ name: 'Personalizar' })
</script>
  ...
  <template>
    <main>
      <div class="hero">
        <div class="hero-inner">
          <div class="hero-text">
            ...
            <div class="hero-sub">Decoração, acessórios e muito mais com tecnologia de impressão 3D de alto nível. Cada
              peça é para você.</div>
            <div class="hero-ctas">
          ...
          <div class="hero-cards">
            <div class="hero-mini-card" v-for="p in produtosDestaqueHero" :key="p.id"
              @click="router.push({ name: 'Produto', params: { id: p.id } })">
      ...
      <div class="section">
        <div class="sec-hd">
          <div class="sec-hd-left">
            ...
            <div>
              ...
              <div class="sec-title-txt"><span class="material-symbols-outlined">local_fire_department</span>
                Recomendados por nós</div>
            </div>
          </div>
        ...
        <div class="carousel-outer">
          ...
          <div class="carousel-dots">
            <div v-for="n in (maxPosC1 + 1)" :key="n" class="dot" :class="{ act: posC1 === (n - 1) }"
              @click="setPosC1(n - 1)"></div>
          </div>
        </div>
      </div>
      ...
      <div class="banner-strip">
        <div class="banner-inner">
          <div class="banner-text">
            ...
            <button class="btn-banner" @click="irPersonalizar">
      ...
      <div class="section" style="padding-bottom:60px;">
        ...
        <div class="carousel-dots">
          <div v-for="n in (maxPosC2 + 1)" :key="n" class="dot" :class="{ act: posC2 === (n - 1) }"
            @click="setPosC2(n - 1)"></div>
        </div>
      </div>
    </main>
  </template>
